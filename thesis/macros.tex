...
\newcommand{\exercise}[1]{\raisebox{1pt}{\scriptsize$\gg$}\,#1}
...
\newcommand{\labcall}[4]{\langle #1@#2,#3@#4 \rangle}%{\langle #1,#2,#3,#4 \rangle}
...
\newcommand{\abstrue}{\widehat{\true}}
\newcommand{\absfalse}{\widehat{\false}}
\newcommand{\absunit}{\widehat{\unit}}
\newcommand{\absundef}{\widehat{\undef}}

\newcommand{\absC}{{\cal C}}

% types
\newcommand{\Base}{\mathsf{Base}}
\newcommand{\escal}[2]{#1 \rightsquigarrow #2}
\newcommand{\funT}[3]{#1\to #2 :: #3}
\newcommand{\chanT}[3]{#1\triangleleft #2 :: #3}
\newcommand{\refT}[2]{\mathsf{Ref}_{#2}(#1)}
\newcommand{\expT}[2]{#1 :: #2}

\newcommand{\gv}{\Gamma\vdash}
\newcommand{\gvs}{\Gamma\vdash_{\rho_s}}

\newcommand{\MsgPriv}[3]{\bigoplus_{#3} #1 > #2}
\newcommand{\obranch}{\,\oplus\,}
